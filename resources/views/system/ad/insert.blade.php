...
@section('content')
      ...
      <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="{{'/sys/index'}}">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="{{'/sys/ad'}}">广告管理</a><span class="crumb-step">&gt;</span><span>新增广告</span></div>
        </div>
