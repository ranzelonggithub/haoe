...
<head>
    ...
    <link rel="stylesheet" href="{{asset('Home/css/restaurant.css')}}"/>
    <style>
        .mark{top:0;}
    </style>
    ...
    <section class="common-width">
         <header class="header clearfix back-tan fs14">
            <div class="common-width">
               <a href="javascript:;" class="fl landing-header">鲜芋仙</a>
            </div>
        </header>
        
            <div class="landing-banner">
                <img src="{{asset('Home/images/xianyuxian.jpg')}}" />
            </div>
        ...
        <section class="restaurant-main common-width" lazy-img-load>
            ...
            <ul class="clearfix">
                    ...
                    <li class="restaurant-item fl">
                        <div class="img-box fl">
                            <a href="shop_detail.html">
                                <img src="{{asset('Home/images/restaurant_09.png')}}" style="border:1px solid #EEE ;" width="82px" height="82px">
                            </a>
                        </div>
                        <article class="restaurant-introduce fl">
                            <h3 class="ellipsis"><a href="/Shanghai/XianYuXianChuanQiGuangChang/menu/?gid=">鲜芋仙 (传奇广场)</a></h3>
                            <dl class="clearfix">
                                <dt class="fl">饮料小吃</dt>
                    ...
                    <li class="restaurant-item fl">
                        ...
                        <article class="restaurant-introduce fl">
                            <h3 class="ellipsis"><a href="shop_detail.html">鲜芋仙 (南方商城店)</a></h3>
                            <dl class="clearfix">
                                <dt class="fl">饮料小吃</dt>
                                <dd class="small-star fl">
                                    <div class="small-star score" style="width:65.00px"></div>
                                </dd>
                            </dl>
                            <div class="restaurant-state">
                    ...
                    <li class="restaurant-item fl">
                        <div class="img-box fl">
                            <a href="shop_detail.html">
                                <img src="http://dhcrestaurantlogo.dhero.cn/752?v=1402216533" width="82px" height="82px">
                            </a>
                        </div>
                        <article class="restaurant-introduce fl">
                            <h3 class="ellipsis"><a href="shop_detail.html">鲜芋仙 (古美路店)</a></h3>
                            <dl class="clearfix">
                                <dt class="fl">饮料小吃</dt>
                                <dd class="small-star fl">
                                    <div class="small-star score" style="width:52.00px"></div>
                    ...
                    <li class="restaurant-item fl">
                        <div class="img-box fl">
                            <a href="shop_detail.html">
                                <img src="http://dhcrestaurantlogo.dhero.cn/2980?v=1402216533" width="82px" height="82px">
                            </a>
                        </div>
                        <article class="restaurant-introduce fl">
                            <h3 class="ellipsis"><a href="shop_detail.html">鲜芋仙 (川沙店)</a></h3>
                            <dl class="clearfix">
                                <dt class="fl">饮料小吃</dt>
                                <dd class="small-star fl">
                                    <div class="small-star score" style="width:52.00px"></div>
            ...
            <ul class="clearfix">
                    ...
                    <li class="restaurant-item fl">
                        ...
                        <article class="restaurant-introduce fl">
                            <h3 class="ellipsis"><a href="shop_detail.html">鲜芋仙 (吴江路店)</a></h3>
                            <dl class="clearfix">
                                <dt class="fl">饮料小吃</dt>
                                <dd class="small-star fl">
                                    <div class="small-star score" style="width:52.00px"></div>
                    ...
                    <li class="restaurant-item fl">
                        <div class="img-box fl">
                            <a href="shop_detail.html">
                                <img src="http://dhcrestaurantlogo.dhero.cn/2979?v=1402216533" width="82px" height="82px">
                            </a>
                        </div>
                        <article class="restaurant-introduce fl">
                            <h3 class="ellipsis"><a href="shop_detail.html">鲜芋仙 (虹口店)</a></h3>
                            <dl class="clearfix">
                                <dt class="fl">饮料小吃</dt>
                                <dd class="small-star fl">
                                    <div class="small-star score" style="width:52.00px"></div>
                    ...
                    <li class="restaurant-item fl">
                        <div class="img-box fl">
                            <a href="shop_detail.html">
                                <img src="http://dhcrestaurantlogo.dhero.cn/1142?v=1402216533" width="82px" height="82px">
                            </a>
                        </div>
                        <article class="restaurant-introduce fl">
                            <h3 class="ellipsis"><a href="shop_detail.html">鲜芋仙 (控江店)</a></h3>
                            <dl class="clearfix">
                                <dt class="fl">饮料小吃</dt>
                                <dd class="small-star fl">
                                    <div class="small-star score" style="width:0.00px"></div>
                                </dd>
                            </dl>
                            <div class="restaurant-state">
