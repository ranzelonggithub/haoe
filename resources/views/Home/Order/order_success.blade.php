...
<head>
    ...
    <link rel="stylesheet" href="{{asset('Home/css/confirm.css')}}"/>
...
<body class="day " ng-controller="bodyCtrl"  day-or-night>
	...
	<section class="confirm-main common-width clearfix">
        ...
        <div class="app_download fl">
            <h4>下载外卖超人手机App</h4>
            <p>用手机扫描下方二维码</p>
            <p><img src="{{asset('Home/images/confirm_code.png')}}" alt="App二维码" class="code-img"/></p>
            <p>或电脑直接下载</p>
            <div class="down-btn">
            ...
            <div class="chaoren-weixin">
                <img src="{{asset('Home/images/confirm_code_small.png')}}" class="code-img"/>
...
<script src="{{asset('Home/js/confirm.js')}}"></script>
